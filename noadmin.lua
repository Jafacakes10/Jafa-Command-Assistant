minetest.register_chatcommand("noadmin", {
    ...
    func = function(name, params)
        if params == "me" then
            local privs = minetest.set_player_privs(name, {interact=true,give=nil,teleport=nil,bring=nil,fast=nil,fly=nil,noclip=nil,shout=true,announce=nil,settime=nil,privs=nil,basic_privs=nil,kick=nil,ban=nil,rollback=nil,protection=nil,server=nil,debug=nil})
            minetest.chat_send_player(name, "All privs have been revoked from you!")
        else
